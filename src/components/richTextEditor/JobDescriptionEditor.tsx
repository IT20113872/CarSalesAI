...
export default function JobDescriptionEditor({
  ...
  const editor = useEditor({
      ...
      StarterKit.configure({
        ...
        bulletList: false,   // disable default bullet list from StarterKit
        orderedList: false,  // disable default ordered list from StarterKit
        listItem: false,     // disable default list item from StarterKit
      }),
      Heading.configure({
